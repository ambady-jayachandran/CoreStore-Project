...
urlpatterns = [
    ...
    path('order/return/<uuid:order_id>/<uuid:order_item_id>/', views.return_product, name='return_product'),
    path('order/return/success/<uuid:order_id>/', views.return_success, name='return_success'),
